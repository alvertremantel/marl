...
fn empty_neighbors(pos: [u16; 3], cell_map: &HashMap<[u16; 3], usize>) -> Vec<[u16; 3]> {
    FACE_OFFSETS
        .iter()
        .filter_map(|&(dx, dy, dz)| {
...
fn find_cell_neighbor(pos: [u16; 3], cell_map: &HashMap<[u16; 3], usize>) -> Option<usize> {
